 ...
 *
 * @param {Seadragon.Controller} controller  Sets <code>this.controller</code>.
 */
Seadragon.LayoutManager = function LayoutManager(controller) {
    /**
...
Seadragon.LayoutManager.prototype = {
    /**
    ...
    _alignRowsOrColumns: function (alingInRows, heightOrWidth, spaceBetweenImages, maxRowWidthOrColumnHeight,
        ...
        this.controller.dziImages.forEach(function (dziImage, whichImage) {
            ...
            that.controller.fitBounds(whichImage, newBounds, immediately);
        });
    },
    ...
    showDzi: function showDzi(whichImage, immediately) {
        this.controller.drawer.showDzi(whichImage, immediately);
    ...
    hideDzi: function hideDzi(whichImage, immediately) {
        this.controller.drawer.hideDzi(whichImage, immediately);
        this.controller.restoreUpdating();
    }
};
