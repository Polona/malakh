// WARNING!!! This is a modified version, do NOT re-paste the original here!
...
(function ($) {
    ...
    function handler(event) {
        // This is valid because this function invoked only as an event handler function.
        /*jshint validthis:true */

        var orgEvent = event || window.event,
            args = [].slice.call(arguments, 1),
            delta = 0, deltaX = 0, deltaY;
